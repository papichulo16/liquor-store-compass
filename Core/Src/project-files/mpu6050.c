...
int MPU6050_init(I2C_HandleTypeDef* i2c) {
...
void MPU6050_Read_Accel (I2C_HandleTypeDef* i2c, float* Ax, float* Ay, float* Az) {
	uint8_t Rec_Data[6];
...
void MPU6050_Read_Gyro(I2C_HandleTypeDef* i2c, float* Gx, float* Gy, float* Gz) {
    uint8_t Rec_Data[6];
